...
public class ProbarTratarPrecipitaciones {
	...
	public static void main(String[] args) {
		...
		int[][] precipitaciones = new int[][] { { 5, 0, 11, 15, 9, 8, 6, 4, 5, 4, 7, 7 },
				{ 6, 4, 14, 14, 8, 5, 5, 2, 7, 5, 8, 7 }, { 8, 4, 15, 14, 10, 3, 4, 3, 6, 4, 9, 7 },
				{ 15, 5, 10, 25, 11, 6, 5, 5, 7, 12, 11, 15 }, { 12, 3, 7, 21, 8, 6, 4, 6, 7, 8, 10, 14 },
				{ 13, 3, 9, 21, 9, 2, 3, 3, 6, 14, 14, 15 }, { 5, 2, 7, 19, 11, 10, 5, 6, 7, 5, 10, 15 },
		...
		try {
			...
			System.out.println("Se encontró el siguiente error en Prueba 1 :" + e.getMessage());
		}
		...
		try {
			...
			System.out.println("Se encontró el siguiente error en Prueba 2 :" + e.getMessage());
		}
		...
		//prueba 3
				try {
					...
					System.out.println("Se encontró el siguiente error en Prueba 3 :" + e.getMessage());
				}
...
//		
//		for (int i=0; i<precipitaciones.length; i++) {
//			System.out.format("%n Localidad %d  : Mes mínimo: %d   Mes Máximo: %d",
